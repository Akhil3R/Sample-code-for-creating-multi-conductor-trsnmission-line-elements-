...
Constraint {
  { Name Dirichlet_Ele; Type Assign;
    Case {
      ...
      { Region Electrode3; Value 0.; }
      { Region Electrode4; Value 0.; }
      { Region Electrode5; Value 0.; }
      { Region Electrode6; Value 0.; }
      { Region Electrode7; Value 0.; }
      { Region Electrode8; Value 0.; }
      { Region Electrode9; Value 0.; }
      { Region Electrode10; Value 0.; }
    }
  }
}
...
PostProcessing {
  { Name EleSta_v; NameOfFormulation Electrostatics_v;
    Quantity {
      ...
      { Name U1; Value { Term { [ {U1} ]; In Electrode1; } } }
      { Name U2; Value { Term { [ {U2} ]; In Electrode2; } } }
      { Name U3; Value { Term { [ {U3} ]; In Electrode3; } } }
      { Name U4; Value { Term { [ {U4} ]; In Electrode4; } } }
      { Name U5; Value { Term { [ {U5} ]; In Electrode5; } } }
      { Name U6; Value { Term { [ {U6} ]; In Electrode6; } } }
      { Name U7; Value { Term { [ {U7} ]; In Electrode7; } } }
      { Name U8; Value { Term { [ {U8} ]; In Electrode8; } } }
      { Name U9; Value { Term { [ {U9} ]; In Electrode9; } } }
      { Name U10; Value { Term { [ {U10} ]; In Electrode10; } } }
    }
  }
}
...
PostOperation {
  { Name Map; NameOfPostProcessing EleSta_v;
    Operation {
      ...
      Print[ U1, OnRegion Electrode1, Format Table, File >> "output.txt" ];

      Echo[ "Electrode2 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q2, OnRegion Electrode2, Format Table, File >> "output.txt" ];
      Echo[ "Electrode2 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U2, OnRegion Electrode2, Format Table, File >> "output.txt" ];

      Echo[ "Electrode3 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q3, OnRegion Electrode3, Format Table, File >> "output.txt" ];
      Echo[ "Electrode3 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U3, OnRegion Electrode3, Format Table, File >> "output.txt" ];

      Echo[ "Electrode4 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q4, OnRegion Electrode4, Format Table, File >> "output.txt" ];
      Echo[ "Electrode4 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U4, OnRegion Electrode4, Format Table, File >> "output.txt" ];

      Echo[ "Electrode5 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q5, OnRegion Electrode5, Format Table, File >> "output.txt" ];
      Echo[ "Electrode5 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U5, OnRegion Electrode5, Format Table, File >> "output.txt" ];

      Echo[ "Electrode6 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q6, OnRegion Electrode6, Format Table, File >> "output.txt" ];
      Echo[ "Electrode6 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U6, OnRegion Electrode6, Format Table, File >> "output.txt" ];

      Echo[ "Electrode7 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q7, OnRegion Electrode7, Format Table, File >> "output.txt" ];
      Echo[ "Electrode7 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U7, OnRegion Electrode7, Format Table, File >> "output.txt" ];

      Echo[ "Electrode8 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q8, OnRegion Electrode8, Format Table, File >> "output.txt" ];
      Echo[ "Electrode8 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U8, OnRegion Electrode8, Format Table, File >> "output.txt" ];

      Echo[ "Electrode9 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q9, OnRegion Electrode9, Format Table, File >> "output.txt" ];
      Echo[ "Electrode9 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U9, OnRegion Electrode9, Format Table, File >> "output.txt" ];

      Echo[ "Electrode10 charge [C]:", Format Table, File >> "output.txt"] ;
      Print[ Q10, OnRegion Electrode10, Format Table, File >> "output.txt" ];
      Echo[ "Electrode10 potential [V]:", Format Table, File >> "output.txt"] ;
      Print[ U10, OnRegion Electrode10, Format Table, File >> "output.txt" ];
    }
  }
}
